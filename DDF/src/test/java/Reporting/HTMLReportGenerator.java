...
public class HTMLReportGenerator {
	...
	public static String HTMLReportPath=System.getProperty("user.dir") + "\\src\\test\\resources\\ExecutionOutputReport\\" + File.separator + "Output.html";
	public static ArrayList<String> TestCasesDiscription=new ArrayList<String>();
	
	
	public static void CreateHTMLReportContent()
	{
		Base_Class.log.debug("Creating Final Execution HTML Report.");
	...
	private static void CreateFinalHTMLReport(String filePath, String Content)
	{
		try{
		...
		writer.close();
		Base_Class.log.debug("Execution HTML Report Genrated.");
		}
		catch(Exception e)
		{
			Base_Class.log.debug("Error Occured While Creating Final HTML Execution Report, Exception = >" + e.getStackTrace());
		}
	}
}
